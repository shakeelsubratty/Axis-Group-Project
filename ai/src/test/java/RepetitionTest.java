...
public class RepetitionTest
{
	...
	{
		Response a = new Response("42", "This is a response.", "42");
	...
	{
		Response a = new Response("42", "This is a response.", "42");
		Response b = new Response("42", "This is a response.", "42");
		Response c = new Response("1337", "This is another response.", "1337");
